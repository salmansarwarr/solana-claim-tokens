...
const Footer = () => {
  return (
    <footer className="px-6 md:px-10 py-6 h-auto md:h-[20vh] flex flex-col md:flex-row items-center gap-6 md:gap-10 border-t bg-gray-50">
      <Image src={MethaLogo} className="w-14" alt="Metha Logo" />
